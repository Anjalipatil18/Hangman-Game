...
def ifValid(user_input):
    ...
    if not user_input.isalpha():#isalpha is a function in that we can checke our alphabet or not!!
        return False
...
def get_available_letters(letters_guessed):
    ...
    '''
    import string
    all_letters = string.ascii_lowercase #ascii_lowercase is a function
    letters_left=""
